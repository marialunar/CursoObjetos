...
public class Clase03 {
    public static void main(String[] args) {
        ...
        switch (dia) {
            ...
            default: System.out.println("El dia no es valido");
             
        }
        //en el switch tradicional el default no es obligatorio

        switch (dia) {
           case 1,2,3,4,5:System.out.println("Es dia de semana"); break;
           case 6,7: System.out.println("Es fin de semana");
        }

        //rule switch (JDK 14)
        //reemplaza los : por ->
        //desaparece el uso del break
        //se puede utilizar como expresion
        ...
        System.out.println("Se sumaran los numeros enteros, pares, positivos");
        System.out.println("Siempre y cuando la suma no supere los 100");
        do{
            System.out.println("Ingrese un numero para sumar o el 0 para salir");
            numero=teclado.nextInt();
            if (numero %2 != 0) continue;
            if (numero > 0) suma += numero;
            if (suma > 100) break; 
        }while (numero != 0);
        System.out.println("La suma de todos los numeros enteros, pares, positivos es de:"+suma);
